             ...
             ,
              ...
              const SizedBox(
               ...
               CustomTextFormAuth(
                ...
                labelText: "Email",hintText: "Enter your email",iconData: Icons.email_outlined,textEditingController: controller.email,
               ),
              const SizedBox(height: 20,),
               CustomTextFormAuth(
                ...
                labelText: "Password",hintText: "Enter your password",iconData: Icons.lock_outline,textEditingController: controller.password,),
              InkWell(
                onTap: (){
                  controller.goToForgetPassword();
                },
                child: Text("4".tr, textAlign: TextAlign.end,),
              ),
              CustomButtonAuth(onPressed: (){
                controller.login();
              },text: "5".tr,),
             CustoTextSignUpOrSignIn(textone: "6".tr,texttwo: "7".tr, onTab: (){
